...
export const metadata: Metadata = {
  ...
  description:
    'A live civilizational stress composite across 25 countries and 31 indicators, grouped into five meta-indexes: economic, social, mental, technological, environmental. Every number traceable to its source.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Five-dimension civilizational stress composite — economic, social, mental, technological, environmental — across 25 countries. Live, sourced, traceable.',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'The Human Index — Civilizational Stress Tracker',
    description: 'A live civilizational stress composite across 25 countries and 5 meta-indexes — economic, social, mental, technological, environmental.',
    images: ['/og-image.png'],
  },
  alternates: {
