    ...
    <div style={{ minHeight: '100vh', background: theme.bg, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '48px 16px' }}>
      <div style={{ width: '100%', maxWidth: 640 }}>
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          <h1 style={{ fontSize: 32, fontWeight: 300, color: theme.text, marginBottom: 16, fontFamily: theme.fontHeading }}>
            Your Exposure Assessment
          </h1>
          <p style={{ fontSize: 15, color: theme.textSecondary, fontFamily: theme.fontBody, lineHeight: 1.6 }}>
