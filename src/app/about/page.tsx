  ...
  return (
    <article className="min-h-screen">
      ...
      <section className="max-w-prose-wide mx-auto px-4 sm:px-6 lg:px-8 py-10 border-t border-border">
        ...
        <div className="prose prose-thi">
          <p>
            The Human Index is an independent, open-source project. The code
            runs on a public cron with publicly visible source health. The
            editorial layer is generated by Claude on top of validated data,
            then validated again before being published.
          </p>
          <p>
            If you spot a bad number, a missing source, or a misframing —
            please <Link href="/contact">get in touch</Link>. The credibility
            of this kind of project is built on whether we respond to
